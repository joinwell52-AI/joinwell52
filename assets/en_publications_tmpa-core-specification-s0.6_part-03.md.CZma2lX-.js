import{_ as n,o as a,c as s,a2 as t}from"./chunks/framework.Cm6XCzck.js";const h=JSON.parse('{"title":"5. Threat Model and Trust Assumptions","description":"","frontmatter":{},"headers":[],"relativePath":"en/publications/tmpa-core-specification-s0.6/part-03.md","filePath":"en/publications/tmpa-core-specification-s0.6/part-03.md","lastUpdated":1786288964000}'),i={name:"en/publications/tmpa-core-specification-s0.6/part-03.md"};function r(o,e,p,l,c,d){return a(),s("div",null,[...e[0]||(e[0]=[t(`<pre><code>    &quot;hash_algorithm&quot;: { &quot;type&quot;: &quot;string&quot;, &quot;minLength&quot;: 1 },
...
<span class="line"><span></span></span>
<span class="line"><span>Schema processors used for C01 SHALL implement JSON Schema Draft 2020-12 \`format\` assertion for \`created_at\`. A processor that treats \`date-time\` as annotation-only is insufficient. The linked S0.6 machine-readable artifact is the normative schema byte sequence; the embedded rendering above SHALL remain semantically identical to it.</span></span>
<span class="line"><span></span></span>
<span class="line"><span>| S0.6 machine-readable artifact | SHA-256 |</span></span>
<span class="line"><span>|---|---|</span></span>
<span class="line"><span>| [Governance Object Schema](/spec/tmpa/s0.6/governance-object.schema.json) | \`623fd1d639defa441353993a3f5c1b228889d8977f5ac199d05c23f4683d036b\` |</span></span>
<span class="line"><span>| [Lifecycle Profile Schema](/spec/tmpa/s0.6/lifecycle-profile.schema.json) | \`df925fc3c515f680e2f699ef5e82aba00c299ba63675d520effb0c006e6ce9d8\` |</span></span>
<span class="line"><span>| [Reader Result Schema](/spec/tmpa/s0.6/reader-result.schema.json) | \`f62aca5fb0a696bf92cd89bbf84e8c59d185d45af8f189504151c18509cc4f59\` |</span></span>
<span class="line"><span>| [Conformance Result Schema](/spec/tmpa/s0.6/conformance-result.schema.json) | \`11c21a8d4dc8ef1b9f9990123a6deb4870a39232574f9565d7d95ed78a808749\` |</span></span>
<span class="line"><span></span></span>
<span class="line"><span>The lifecycle-profile schema requires explicit \`acceptance\`, \`work_graph\`, \`risk_policy\`, and \`failure_model\` sections in addition to states, actions, transitions, and recovery rules. S0.6 additionally requires the risk policy to identify permitted approval-object types and whether the approver must be independent. These sections make FCoP-derived collaboration-cycle semantics inspectable without binding TMPA to the FCoP reference implementation or to CodeFlowMu.</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>A canonicalization profile must define the exact representation covered by the digest and, when signatures are used, the exact representation covered by the signature. It must also define how self-referential integrity fields are excluded or normalized. TMPA Core S0.6 requires that this profile be declared; it does not prescribe one universal byte-level canonicalization algorithm.</span></span>
<span class="line"><span></span></span>
