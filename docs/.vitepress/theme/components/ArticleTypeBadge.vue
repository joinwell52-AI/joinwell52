...
const dimensionLabels = computed(() => chinese.value
  ? {
      evidenceRigor: '证据',
      originalJudgment: '原创',
      structureExpression: '结构',
      engineeringUsefulness: '实用'
    }
  : {
      evidenceRigor: 'Evidence',
      originalJudgment: 'Judgment',
      structureExpression: 'Structure',
      engineeringUsefulness: 'Usefulness'
    })
</script>
