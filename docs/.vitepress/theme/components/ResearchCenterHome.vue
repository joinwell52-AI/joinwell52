...
const copy = computed(() => zh.value ? {
  ...
  publications: [
    { version:'A0.8', kind:'主论文', title:['TMPA','架构论文'], status:'S0.6 · I0.8 证据对齐', path:'/zh/publications/tmpa-architecture-paper-a0.8', tone:'paper' },
  ...
  systems: [
    ...
    { no:'04', kind:'理论', role:'文本多智能体流程架构', name:['TMPA'], description:'独立记录治理理论、规范对象与 Reader 行为，为协议与运行层提供理论基础，但不把工场日常产出自动当作论文证据。', path:'/zh/publications/tmpa-architecture-paper-a0.8', logo:'/logo.svg?v=tmpa-20260807-5', tone:'tmpa', cta:'论文与规范' }
  ],
  ...
  publications: [
    { version:'A0.8', kind:'PRIMARY PAPER', title:['TMPA','Architecture Paper'], status:'S0.6 · I0.8 evidence aligned', path:'/en/publications/tmpa-architecture-paper-a0.8', tone:'paper' },
      ...
      <div class="rc-shell rc-site-footer__grid">
        <div class="rc-site-footer__brand">
          <div class="rc-product-mark rc-product-mark--footer" aria-label="TMPA, FCoP, CodeFlowMu">
            <a :href="link(zh ? '/zh/publications/tmpa-architecture-paper-a0.8' : '/en/publications/tmpa-architecture-paper-a0.8')" title="TMPA"><img src="/logo.svg?v=tmpa-20260807-5" alt="TMPA logo"><span>TMPA</span></a>
