...
const copy = computed(() => zh.value ? {
  ...
  publications: [
    { version:'A0.9', kind:'主论文', title:['TMPA','架构论文'], status:'理论指导关系定稿', path:'/zh/publications/tmpa-architecture-paper-a0.9', tone:'paper' },
  ...
  systems: [
    ...
    { no:'04', kind:'理论', role:'文本多智能体流程架构', name:['TMPA'], description:'独立记录治理理论、规范对象与 Reader 行为，通过 Core 与 FCoP 指导 CodeFlowMu 工程落实，但不把工程结果自动当作理论证明。', path:'/zh/publications/tmpa-architecture-paper-a0.9', logo:'/logo.svg?v=tmpa-20260807-5', tone:'tmpa', cta:'论文与规范' }
  ],
  ...
  publications: [
    { version:'A0.9', kind:'PRIMARY PAPER', title:['TMPA','Architecture Paper'], status:'Theory-guidance relation finalized', path:'/en/publications/tmpa-architecture-paper-a0.9', tone:'paper' },
      ...
      <div class="rc-shell rc-site-footer__grid">
        <div class="rc-site-footer__brand">
          <div class="rc-product-mark rc-product-mark--footer" aria-label="TMPA, FCoP, CodeFlowMu">
            <a :href="link(zh ? '/zh/publications/tmpa-architecture-paper-a0.9' : '/en/publications/tmpa-architecture-paper-a0.9')" title="TMPA"><img src="/logo.svg?v=tmpa-20260807-5" alt="TMPA logo"><span>TMPA</span></a>
