    ...
    <div class="rcv5-shell">
      ...
      <section class="rcv5-section">
        ...
        <div class="rcv5-pubs">
          ...
          <a :href="p('/en/publications/implementation-case-i0.5', '/zh/publications/implementation-case-i0.5')"><img :src="base('/assets/covers/implementation-case.svg')" alt="Implementation Case"><div><span>CASE · I0.5</span><h3>Implementation Case Report</h3><p>{{ zh ? 'S0.4 基线与 WP-13 多 Agent 证据门控案例。' : 'S0.4 baseline and the WP-13 multi-agent evidence-gating case.' }}</p><b>Read · Cite · Versions →</b></div></a>
        </div>
      </section>
