    ...
    <div class="rcv5-shell">
      ...
      <section class="rcv5-section">
        ...
        <div class="rcv5-pubs">
          ...
          <a :href="p('/en/publications/tmpa-architecture-paper-a0.8', '/zh/publications/tmpa-architecture-paper-a0.8')"><img :src="base('/assets/covers/tmpa-paper.svg')" alt="TMPA Architecture Paper"><div><span>PAPER · A0.8</span><h3>TMPA Architecture Paper</h3><p>{{ zh ? '吸收 S0.6 与 I0.8 证据的投稿前审稿修订版。' : 'Pre-submission review draft aligned to S0.6 and I0.8 evidence.' }}</p><b>Read · Cite · Versions →</b></div></a>
