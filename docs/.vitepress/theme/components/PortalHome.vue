    ...
    <div class="rcv5-shell">
      ...
      <section class="rcv5-section">
        ...
        <div class="rcv5-pubs">
          ...
          <a :href="p('/en/publications/tmpa-architecture-paper-a0.7', '/zh/publications/tmpa-architecture-paper-a0.7')"><img :src="base('/assets/covers/tmpa-paper.svg')" alt="TMPA Architecture Paper"><div><span>PAPER · A0.7</span><h3>TMPA Architecture Paper</h3><p>{{ zh ? '投稿前审稿修订版。' : 'Pre-submission review draft.' }}</p><b>Read · Cite · Versions →</b></div></a>
