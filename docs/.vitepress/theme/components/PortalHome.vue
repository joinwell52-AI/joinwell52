    ...
    <div class="rcv5-shell">
      ...
      <section class="rcv5-section">
        ...
        <div class="rcv5-pubs">
          ...
          <a :href="p('/en/publications/implementation-case-i0.7', '/zh/publications/implementation-case-i0.7')"><img :src="base('/assets/covers/implementation-case.svg')" alt="Implementation Case"><div><span>CASE · I0.7</span><h3>Implementation Case Report</h3><p>{{ zh ? 'CodeFlowMu V1.4.1 锁定运行：C01–C14 作者本地 14/14 PASS。' : 'Locked CodeFlowMu V1.4.1 run: author-local C01–C14 14/14 PASS.' }}</p><b>Read · Cite · Versions →</b></div></a>
        </div>
      </section>
