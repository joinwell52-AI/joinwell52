    ...
    <div class="rcv5-shell">
      ...
      <section class="rcv5-section">
        ...
        <div class="rcv5-pubs">
          ...
          <a :href="p('/en/publications/tmpa-core-specification-s0.5', '/zh/publications/tmpa-core-specification-s0.5')"><img :src="base('/assets/covers/tmpa-spec.svg')" alt="TMPA Core Specification"><div><span>SPEC · S0.5</span><h3>TMPA Core Specification</h3><p>{{ zh ? 'FCoP 派生的 RFC 风格可实现核心规范。' : 'FCoP-derived implementable RFC-style Core specification.' }}</p><b>Read · Cite · Versions →</b></div></a>
