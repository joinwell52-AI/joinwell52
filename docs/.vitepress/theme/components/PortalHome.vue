    ...
    <div class="rcv5-shell">
      ...
      <section class="rcv5-section">
        ...
        <div class="rcv5-pubs">
          ...
          <a :href="p('/en/publications/tmpa-architecture-paper-a0.6', '/zh/publications/tmpa-architecture-paper-a0.6')"><img :src="base('/assets/covers/tmpa-paper.svg')" alt="TMPA Architecture Paper"><div><span>PAPER · A0.6</span><h3>TMPA Architecture Paper</h3><p>{{ zh ? '投稿级学术研究稿。' : 'Submission-oriented academic paper.' }}</p><b>Read · Cite · Versions →</b></div></a>
          ...
          <a :href="p('/en/publications/implementation-case-i0.6', '/zh/publications/implementation-case-i0.6')"><img :src="base('/assets/covers/implementation-case.svg')" alt="Implementation Case"><div><span>CASE · I0.6</span><h3>Implementation Case Report</h3><p>{{ zh ? 'S0.5 作者运行产品证据与 WP-13 多 Agent 治理案例。' : 'S0.5 author-run product evidence and the WP-13 governance case.' }}</p><b>Read · Cite · Versions →</b></div></a>
        </div>
      </section>
