    ...
    <div class="rcv5-shell">
      ...
      <section class="rcv5-section">
        ...
        <div class="rcv5-pubs">
          ...
          <a :href="p('/en/publications/tmpa-architecture-paper-a0.5', '/zh/publications/tmpa-architecture-paper-a0.5')"><img :src="base('/assets/covers/tmpa-paper.svg')" alt="TMPA Architecture Paper"><div><span>PAPER · A0.5</span><h3>TMPA Architecture Paper</h3><p>{{ zh ? '正式研究论文。' : 'Formal research paper.' }}</p><b>Read · Cite · Versions →</b></div></a>
          ...
          <a :href="p('/en/publications/implementation-case-i0.4', '/zh/publications/implementation-case-i0.4')"><img :src="base('/assets/covers/implementation-case.svg')" alt="Implementation Case"><div><span>CASE · I0.4</span><h3>Implementation Case Report</h3><p>{{ zh ? 'FCoP、CodeFlowMu 与小典 AI 工程证据。' : 'Engineering evidence from FCoP, CodeFlowMu and XiaoDian AI.' }}</p><b>Read · Cite · Versions →</b></div></a>
        </div>
      </section>
