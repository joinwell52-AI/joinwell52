...
const enSidebar = {
  ...
  '/en/publications/': [{ text: 'Publication Center', items: [
    ...
    { text: 'TMPA Architecture Paper A0.8', link: '/en/publications/tmpa-architecture-paper-a0.8' },
...
const zhSidebar = {
  ...
  '/zh/publications/': [{ text: '出版中心', items: [
    ...
    { text: '研究情报系统 V1.0', link: '/zh/runtime/research-intelligence' },
    { text: 'Runtime Scheduler V1.0 历史发布', link: '/zh/publications/research-runtime-scheduler-v1.0' },
    { text: 'TMPA 架构论文 A0.8', link: '/zh/publications/tmpa-architecture-paper-a0.8' },
    ...
    locales: {
      root: {
        ...
        nav: [
          ...
          { text: 'Product Stack', items: [
            { text: 'TMPA', link: '/en/publications/tmpa-architecture-paper-a0.8' },
      ...
      zh: {
        ...
        nav: [
          ...
          { text: '能力体系', items: [
            { text: 'TMPA', link: '/zh/publications/tmpa-architecture-paper-a0.8' },
