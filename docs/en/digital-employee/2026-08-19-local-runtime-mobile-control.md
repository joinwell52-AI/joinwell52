---
title: "How Do You Stay in Control of an AI Team After Leaving Your Computer? A Two-Plane Design for Local Execution and Mobile Control"
date: '2026-08-19'
column: digital-employee
category: daily
article_type: project-research
edition: research-center
research_question: "How can a local agent team separate authoritative PC execution from constrained mobile control while handling weak networks, revision changes, device revocation, and approval boundaries?"
summary: "The computer keeps execution and authoritative facts while the phone provides a revision-bound view and decision surface; uncertain requests return to local authority instead of creating a second truth."
...
<ArticleCover
  ...
  languageHref="/zh/digital-employee/2026-08-19-local-runtime-mobile-control"
  languageLabel="中文"
/>
...
**Series map:** start with [the long-requirement work graph](/en/engineering/2026-08-19-taskbook-to-task-graph), then use [fault injection](/en/engineering/2026-08-19-agent-dispatch-fault-injection) to test the runtime. This article covers remote observation and bounded human decisions after leaving the computer.
...
![Target decision contract in which a phone sends a revision-bound, idempotent request to local authority for device, permission, revision, and replay checks](/assets/covers/daily-2026-08-19-mobile-decision-boundary-en.png)
