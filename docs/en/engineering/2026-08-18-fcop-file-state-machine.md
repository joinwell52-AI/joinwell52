---
title: "Files, Paths, and Events: Implementing and Testing the FCoP State Machine"
date: '2026-08-18'
column: open-source-engineering
category: daily
article_type: project-research
edition: research-center
research_question: "How can FCoP artifact identity, path-addressed state, event history, and atomic publication become an implementable, testable coordination kernel without overstating its guarantees?"
summary: "Grounded in the current specification, code, and targeted tests, this article explains five lifecycle locations, seven legal transitions, transition events, and the write-fsync-replace-cleanup algorithm while preserving concurrency, durability, and exactly-once boundaries."
item_id: "MANUAL-20260818-FCOP"
lifecycle: "Published"
cover: "/assets/covers/daily-2026-08-18-fcop-file-state-machine-cover.webp"
...
<ArticleCover
  image="/assets/covers/daily-2026-08-18-fcop-file-state-machine-cover.webp"
  kicker="Open-source Engineering · Project Research"
  title="Files, Paths, and Events: Implementing and Testing the FCoP State Machine"
  summary="Using the current specification, code, and targeted tests, this article examines five lifecycle locations, seven legal transitions, transition events, and the write–fsync–replace–cleanup algorithm—without overstating concurrency, durability, or exactly-once guarantees."
  version="MANUAL-20260818-FCOP"
  status="Independent Editorial PASS · 2026-08-18"
  languageHref="/zh/engineering/2026-08-18-fcop-file-state-machine"
  languageLabel="中文"
/>
...
![FCoP's five lifecycle locations, seven legal transitions, and separate REPORT and governance REVIEW artifacts](/assets/covers/daily-2026-08-18-fcop-lifecycle-and-artifacts.png)

*Figure 1. The path defines the TASK's current state. A REPORT is execution evidence and a governance REVIEW is a separate judgment; neither moves the TASK by itself. Source: Research Center synthesis of the FCoP v3 specification and implementation.*
...
![FCoP's commit sequence from reading the source through temp write, fsync, replace, and source cleanup](/assets/covers/daily-2026-08-18-fcop-atomic-commit.png)

*Figure 2. `os.replace` is the destination publication point. Source cleanup follows, so the complete cross-directory operation is not one syscall. Source: Research Center synthesis of FCoP's `transition.py` implementation.*
