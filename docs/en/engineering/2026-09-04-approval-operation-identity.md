...
research_question: "Does the real tool entry preserve approval-relevant operation distinctions while separating session context from operation identity?"
...
cover: "/assets/approval-identity-20260904/assets/approval-identity-cover-v2.png"
language: en
lifecycle: Published
...
<ArticleCover
  image="/assets/approval-identity-20260904/assets/approval-identity-cover-v2.png"
  kicker="Open-source engineering · Controlled experiment"
  title="You Approved One Command. Why Did Another Pass? An Experiment in Agent Authorization Identity"
  summary="In the same Agent approval pipeline, changing a Git branch left the authorization digest unchanged, while changing only the Session changed it. Real services, cross-process records, and negative controls show why risk classification, operation identity, and execution authority need different tests."
  version="2026-09-04"
  languageHref="/zh/engineering/2026-09-04-approval-operation-identity"
  languageLabel="中文"
/>
...
The two opposing results warranted investigation: a branch change was accepted, while a session-only change failed to match. The complete probe retained both expectation violations, twice each, and exited with an assertion failure. We did not turn it into an all-green report. The [companion evidence guide](/en/research/evidence/2026-09-04-approval-operation-identity) maps the individual observations.
...
[![Figure 1: Different branch commands produce the same approval identity](https://joinwell52-ai.github.io/joinwell52/assets/approval-identity-20260904/assets/operation-collapse.en.png)](https://joinwell52-ai.github.io/joinwell52/assets/approval-identity-20260904/assets/operation-collapse.en.png)
...
[![Figure 2: Top-level Session is excluded while nested Session remains in the digest](https://joinwell52-ai.github.io/joinwell52/assets/approval-identity-20260904/assets/nested-session.en.png)](https://joinwell52-ai.github.io/joinwell52/assets/approval-identity-20260904/assets/nested-session.en.png)
