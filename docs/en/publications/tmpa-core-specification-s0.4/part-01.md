...
The publication contract is fixed across the three maintained documents: the [Architecture Paper A0.5](/en/publications/tmpa-architecture-paper-a0.5) explains the theory, this Core Specification defines normative behavior, and the [Implementation Case Report I0.4](/en/publications/implementation-case-i0.4) reports bounded engineering evidence. Their current conceptual layering and historical lineage are distinct:
