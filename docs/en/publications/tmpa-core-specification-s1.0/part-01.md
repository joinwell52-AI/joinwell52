---
title: TMPA Core Specification — Evidence Candidate S1.0
outline: deep
citation:
...
> **Specification Version:** Evidence Candidate S1.0<br>
> **Historical Extraction Baseline:** TMPA Draft V1.0-R24; current specification maintained directly in this GitHub document<br>
> **Status:** Version-pinned candidate for product evidence; not yet the official stable release<br>
...
This evidence candidate separates three kinds of text:
