---
title: TMPA Core Specification — Stable Release S1.0
outline: deep
citation:
  work: TMPA Core Specification
  identifier: TMPA-CORE-S1.0
  language: en
  metadata: /releases/tmpa/v1.0/metadata/core-specification.en.cff
---
...
<ArticleCover
  ...
  languageHref="/zh/publications/tmpa-core-specification-s1.0"
  languageLabel="简体中文"
/>
...
The publication contract is fixed across the three maintained documents: the [Architecture Paper A1.0](/en/publications/tmpa-architecture-paper-a1.0) explains the theory, this Core Specification defines normative behavior, and the [Implementation Case Report I1.0](/en/publications/implementation-case-i1.0) reports bounded engineering evidence. Their current guidance relation and historical co-evolution are distinct:
