---
title: TMPA Architecture Paper — Release A1.0
outline: deep
citation:
  work: TMPA Architecture Paper
  identifier: TMPA-ARCH-A1.0
  language: en
  metadata: /releases/tmpa/v1.0/metadata/architecture-paper.en.cff
---
...
<ArticleCover
  ...
  version="A1.0"
  status="Stable research-paper release"
  languageHref="/zh/publications/tmpa-architecture-paper-a1.0"
  languageLabel="简体中文"
/>
...
> **Architecture Paper Release:** A1.0<br>
> **Historical Source Baseline:** TMPA Draft V1.0-R23; theory aligned through R31<br>
> **Status:** Stable V1.0 research-paper release<br>
...
**Document identifier:** TMPA-ARCH-A1.0<br>
