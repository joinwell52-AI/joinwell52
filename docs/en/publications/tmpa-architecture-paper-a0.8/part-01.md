---
title: TMPA Architecture Paper — Pre-Submission Review Draft A0.8
outline: deep
---
...
<ArticleCover
  ...
  languageHref="/zh/publications/tmpa-architecture-paper-a0.8"
  languageLabel="简体中文"
/>
...
> **Architecture Paper Draft:** A0.8<br>
...
**Document identifier:** TMPA-ARCH-A0.8<br>
...
| a file-based protocol and downstream product can realize a substantial subset | FCoP mapping, exact-input CodeFlowMu V1.6.0 product run, and public reproducer | conformance beyond the fixed S0.6 bundle, protocol validity inferred from package tests, or independent adoption |
