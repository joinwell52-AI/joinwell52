...
research_question: "Why does the same assignment in a common coordination system produce different task graphs, deliveries and failures?"
summary: "Six AI teams tested through CodeFlowMu and FCoP: PM assignment, delivery quality, efficiency and recovery, checked against independent EVAL and retained file evidence."
description: "Six AI teams tested through CodeFlowMu and FCoP: PM assignment, delivery quality, efficiency and recovery, checked against independent EVAL and retained file evidence."
cover: "/articles/codeflowmu-six-ai-20260909/assets/hero.png"
item_id: "MANUAL-20260909-CODEFLOWMU-SIX-AI"
lifecycle: "Published"
...
<ArticleCover
  ...
  kicker="RESEARCH · SIX AI TEAMS"
  title="Six AIs, One Task: What Happened?"
  summary="Six AI teams tested through CodeFlowMu and FCoP: PM assignment, delivery quality, efficiency and recovery, checked against independent EVAL and retained file evidence."
  version="Tested 2026-09-09"
  status="File evidence · Independent EVAL · Six dimensions"
  languageHref="/zh/research/2026-09-09-codeflowmu-six-ai"
  languageLabel="简体中文"
/>
...
## 1. CodeFlowMu, FCoP, and the Test {#chapter-1}

### 1.1 What CodeFlowMu and FCoP do {#section-1-1}
...
### 1.2 The exact task {#section-1-2}
...
### 1.3 CodeFlowMu as the test instrument {#section-1-3}
...
### 1.5 Initialization, execution, and timing {#section-1-5}
...
### 1.7 “Files are the truth” means work must be written down {#section-1-7}
...
### 2.1 The six results {#section-2-1}
...
[![Scores for the six integrated runs](/articles/codeflowmu-six-ai-20260909/assets/en-scores.svg)](/articles/codeflowmu-six-ai-20260909/assets/en-scores.svg)

Weights: completion 25, result quality 30, efficiency 15, scope control 15, recovery 10, observability 5. Scores describe these runs, not universal foundation-model ability. Codex and Cursor's one-point difference places them in the same leading group. See the [score data](/articles/codeflowmu-six-ai-20260909/scorecard.csv).

### 2.2 Completion is more than a final paragraph {#section-2-2}
...
### 2.4 Doubao: a smooth chain with weak final review {#section-2-4}
...
### 2.5 DeepSeek: deeper evidence, imperfect interpretation {#section-2-5}
...
### 2.6 Kimi: the team never reached formal downstream work {#section-2-6}
...
### 2.7 Qwen: investigation expanded without complete delivery {#section-2-7}
...
### 2.8 Cursor: authorized recovery left an inspectable history {#section-2-8}
...
### 2.9 How the score should be read {#section-2-9}

[![Scoring dimensions](/articles/codeflowmu-six-ai-20260909/assets/en-score-matrix.svg)](/articles/codeflowmu-six-ai-20260909/assets/en-score-matrix.svg)
...
## 3. What the Evidence Lets Us Analyze {#chapter-3}
...
### 3.1 Compare the PM's entire delivery chain {#section-3-1}
...
### 3.3 Did longer runs buy more useful evidence? {#section-3-3}

[![Elapsed time to delivery or termination](/articles/codeflowmu-six-ai-20260909/assets/en-duration.svg)](/articles/codeflowmu-six-ai-20260909/assets/en-duration.svg)
...
### 3.4 Efficiency is evidence value per unit of effort {#section-3-4}

[![Time versus result-quality score](/articles/codeflowmu-six-ai-20260909/assets/en-quality-time.svg)](/articles/codeflowmu-six-ai-20260909/assets/en-quality-time.svg)
...
### 3.11 Fact checking: return a claim to its source {#section-3-11}
...
### 3.12 Diagnosis: make “stuck” a specific problem {#section-3-12}
...
### 3.13 The two incomplete runs, with precise evidence {#section-3-13}
...
## 4. Conclusions: What CodeFlowMu Made Possible {#chapter-4}

### 4.1 The system made the comparison evidence-based {#section-4-1}
...
### 4.3 Capability, reliable delivery, and review are separate thresholds {#section-4-3}
...
### 4.4 A reliable team also knows when to stop {#section-4-4}
...
### 4.5 Methods, sources, and limits {#section-4-5}
