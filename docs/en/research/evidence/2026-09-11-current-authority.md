---
title: Current-context research — evidence and reproduction
---

# Current-context research — evidence and reproduction

September 11, 2026. Six development groups, nine pull requests, three local experiment tracks.

| Experiment | Local result | Observation boundary |
| --- | --- | --- |
| Agents SDK | 10 original regressions pass; 10 predecessor-helper ablations fail | Real Runner and ScriptedModel inputs, not network acknowledgement |
...
[中文](/zh/research/evidence/2026-09-11-current-authority)
