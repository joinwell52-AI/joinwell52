---
title: "Evidence: restriction enforcement and the check-to-effect interval"
outline: deep
---

<ArticleTableScroll language="en" />

[中文](/zh/research/evidence/2026-09-07-last-check-effect-boundary) · [Download evidence ZIP](https://joinwell52-ai.github.io/joinwell52/assets/last-check-boundary-20260907/last-check-evidence.zip)
...
[Claims](https://joinwell52-ai.github.io/joinwell52/assets/last-check-boundary-20260907/evidence/claims.json) → [source provenance](https://joinwell52-ai.github.io/joinwell52/assets/last-check-boundary-20260907/evidence/sources.json) → [de-identified observations](https://joinwell52-ai.github.io/joinwell52/assets/last-check-boundary-20260907/evidence/observations.json) → this interpretation guide → [record checker](https://joinwell52-ai.github.io/joinwell52/assets/last-check-boundary-20260907/evidence/check-records.mjs) → [file hashes](https://joinwell52-ai.github.io/joinwell52/assets/last-check-boundary-20260907/evidence/manifest.json).
...
[中文说明](https://joinwell52-ai.github.io/joinwell52/assets/last-check-boundary-20260907/evidence/README.zh.md)
