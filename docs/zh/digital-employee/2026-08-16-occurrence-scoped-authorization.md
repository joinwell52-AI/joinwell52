...
item_id: "Q-20260816-01"
lifecycle: "Published"
cover: "/assets/covers/daily-2026-08-16-occurrence-scoped-authorization-cover.png"
...
<ArticleCover
  image="/assets/covers/daily-2026-08-16-occurrence-scoped-authorization-cover.png"
  kicker="数字员工 · 每日研究"
  title="持久化 Agent 授权需要动作实例边界"
  summary="更稳健的持久化授权，需要把宽泛默认策略与单次动作实例例外作为不同事实保存。精确 Call Identity 可以让一次决定跨恢复继续有效，但它并不能证明审批者身份、策略来源或外部效果恰好执行一次。"
  version="Q-20260816-01"
  status="Daily Runtime V5 · 2026-08-16"
  languageHref="/en/digital-employee/2026-08-16-occurrence-scoped-authorization"
