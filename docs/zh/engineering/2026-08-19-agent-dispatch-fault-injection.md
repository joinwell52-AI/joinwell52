---
title: "别被“全绿演示”骗了：怎样用故障注入，测出一个真正靠谱的 AI Agent 调度系统？"
date: '2026-08-19'
column: open-source-engineering
category: daily
article_type: project-research
edition: research-center
research_question: "怎样以治理不变量、故障插入点和可检查裁决测试 AI Agent 调度系统？"
summary: "可靠性测试不应围绕页面是否跑通，而应把一条不可破坏的铁律、一个故障插入位置和一个可检查结果组合成可复现的测试。"
...
<ArticleCover
  ...
  languageHref="/en/engineering/2026-08-19-agent-dispatch-fault-injection"
  languageLabel="English"
/>

# 别被“全绿演示”骗了：怎样用故障注入，测出一个真正靠谱的 AI Agent 调度系统？

**系列导航：**先读[长需求施工图](/zh/engineering/2026-08-19-taskbook-to-task-graph)了解任务怎样进入执行链；本文检查故障发生后系统是否仍知道真实状态；最后阅读[本地运行与手机控制面](/zh/digital-employee/2026-08-19-local-runtime-mobile-control)。
...
![TMPA 治理语义、FCoP 文件协议投影、CodeFlowMu 运行责任与故障测试证据的分层关系](/assets/covers/daily-2026-08-19-governance-to-fault-testing-zh.png)
...
本轮重跑记录比“全绿截图”更有价值，因为它同时出现了通过、未执行和真实失败。完整命令、环境、退出码和原始输出保存在[专项实验记录](https://github.com/joinwell52-AI/joinwell52/blob/main/research/manual-runs/2026-08-19-guided-article-pipeline-round1/02-experiment-run-log.md)。
