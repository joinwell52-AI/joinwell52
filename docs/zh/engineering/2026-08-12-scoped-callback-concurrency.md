...
item_id: "Q-20260812-03"
lifecycle: "Published"
cover: "/assets/covers/daily-2026-08-12-scoped-callback-concurrency.png"
...
<ArticleCover
  image="/assets/covers/daily-2026-08-12-scoped-callback-concurrency.png"
  kicker="开源工程 · 每日研究"
  title="并发不该先问锁：嵌套 Callback 的最小安全单元"
  summary="嵌套 Callback 的安全并发不是先选择锁，而是先建立归属、生命周期、容量和隔离四条边界；一旦越过进程，这些局部边界还必须升级为可持久重建的协议。"
  version="Q-20260812-03"
  status="Daily Runtime V5 · 2026-08-12"
  languageHref="/en/engineering/2026-08-12-scoped-callback-concurrency"
