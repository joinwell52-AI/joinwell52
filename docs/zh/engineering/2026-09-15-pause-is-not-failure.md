...
summary: "暂停应该只是先等一等，为什么恢复后任务还要人工处理？问题藏在一句丢失了原因的“现在不能继续”里。"
...
<ArticleCover image="/assets/execution-facts-20260915/pause-is-not-failure.cover-v1.png" kicker="开源工程观察 · 实验研究" title="只是按了暂停，任务为什么被判出故障？" summary="暂停应该只是先等一等，为什么恢复后任务还要人工处理？问题藏在一句丢失了原因的“现在不能继续”里。" version="2026-09-15" languageHref="/en/engineering/2026-09-15-pause-is-not-failure" languageLabel="English" />
...
MrBlackTongue 在[这份修复提案](https://github.com/paperclipai/paperclip/pull/13443)中报告：团队处于暂停状态时，自动检查未完成任务的程序，可能把任务按预算不足升级处理。这里的预算，是团队或助手被允许使用的费用额度。
...
![后来的恢复，不能改写刚才暂停的原因](/assets/execution-facts-20260915/pause-is-not-failure.figure.zh.svg)
...
[完整源码来源、探针、结果与复跑方法](https://github.com/joinwell52-AI/joinwell52/tree/main/research/manual-runs/2026-09-15-execution-facts)。
