...
## 3. 开发阶段的真实任务校准：把“什么可以比较”收紧到同一语义域
...
## 4. V2.0.4 正式发版后的两张实机截图，证明它已经不是静态展示
