---
title: "证据包：参数兑现与检查到效果"
outline: deep
---

<ArticleTableScroll language="zh" />

[English](/en/research/evidence/2026-09-07-last-check-effect-boundary) · [下载完整证据 ZIP](https://joinwell52-ai.github.io/joinwell52/assets/last-check-boundary-20260907/last-check-evidence.zip)
...
主张见 [claims.json](https://joinwell52-ai.github.io/joinwell52/assets/last-check-boundary-20260907/evidence/claims.json) → 外部版本与状态见 [sources.json](https://joinwell52-ai.github.io/joinwell52/assets/last-check-boundary-20260907/evidence/sources.json) → 正式逐轮数据见 [observations.json](https://joinwell52-ai.github.io/joinwell52/assets/last-check-boundary-20260907/evidence/observations.json) → 本说明定义解释边界 → [check-records.mjs](https://joinwell52-ai.github.io/joinwell52/assets/last-check-boundary-20260907/evidence/check-records.mjs) 检查记录 → [manifest.json](https://joinwell52-ai.github.io/joinwell52/assets/last-check-boundary-20260907/evidence/manifest.json) 提供文件哈希。
...
[English guide](https://joinwell52-ai.github.io/joinwell52/assets/last-check-boundary-20260907/evidence/README.en.md)
