...
三份维护文档的出版契约固定如下：[Architecture Paper A0.4](/zh/publications/tmpa-architecture-paper-a0.4) 解释理论，本 Core Specification 定义规范行为，[Implementation Case Report I0.3](/zh/publications/implementation-case-i0.3) 报告边界明确的工程证据。当前概念分层与历史谱系必须分开表达：
