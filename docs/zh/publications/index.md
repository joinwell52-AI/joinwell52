...
| 类型 | 文档 | 版本 | 状态 |
|---|---|---:|---|
| 论文 | [TMPA Architecture Paper](./tmpa-architecture-paper-a1.0) | A1.0 | 稳定研究论文正式版；TMPA → Core → FCoP → CodeFlowMu 当前指导关系定稿 |
...
TMPA V1.0 开放科学记录：[Zenodo Record](https://zenodo.org/records/21888488) · [Zenodo DOI：10.5281/zenodo.21888488](https://doi.org/10.5281/zenodo.21888488) · [OSF Registration `2jvqd`](https://osf.io/2jvqd/) · [OSF DOI：10.17605/OSF.IO/2JVQD](https://doi.org/10.17605/OSF.IO/2JVQD)。Zenodo 对应可引用的正式发行档案，OSF 对应不可变、带时间戳的登记快照；两者均标识完整套件，并非 A1.0、S1.0 与 I1.0 各自拥有独立记录。
