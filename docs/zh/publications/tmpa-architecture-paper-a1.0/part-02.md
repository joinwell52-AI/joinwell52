...
独立维护的 [TMPA Core Specification S1.0](/zh/publications/tmpa-core-specification-s1.0) 是当前 C01–C14 及全部 SHALL/MUST 条款的唯一规范性来源。[Implementation Case Report I1.0](/zh/publications/implementation-case-i1.0) 报告当前有边界的 S1.0 工程证据基线。I0.6–I0.8 继续作为各自旧输入和产品修订的不可变历史基线。本节按研究问题评估结果，不复制规范正文。
