当前作者运行的 S1.0 证据包为 `tmpa-i1.0-codeflowmu-v1.8.0-s1.0-evidence-20260811.zip`，随 [Implementation Case I1.0](/zh/publications/implementation-case-i1.0) 发布，并可从[公开证据路径](/evidence/tmpa/i1.0/tmpa-i1.0-codeflowmu-v1.8.0-s1.0-evidence-20260811.zip)下载。其 SHA-256 为 `9b92b06c3e46c8019362f55075be4ed066cb7a9c0d9859945b6c3b7de8840d04`。早期 S0.4–S0.6 语料库与 I0.6–I0.8 报告继续作为不可变历史基线保留。除非经过独立重跑，所有产品证据都属于作者生成证据。
