---
title: TMPA 架构论文 — 正式版 A1.0
outline: deep
citation:
  work: TMPA Architecture Paper
  identifier: TMPA-ARCH-A1.0
  language: zh
  metadata: /releases/tmpa/v1.0/metadata/architecture-paper.zh.cff
---
...
<ArticleCover
  ...
  version="A1.0"
  status="稳定研究论文正式版"
  languageHref="/en/publications/tmpa-architecture-paper-a1.0"
