---
title: TMPA Core Specification — 正式发布版 S1.0
outline: deep
citation:
  work: TMPA Core Specification
  identifier: TMPA-CORE-S1.0
  language: zh
  metadata: /releases/tmpa/v1.0/metadata/core-specification.zh.cff
---
...
三份维护文档的出版契约固定如下：[Architecture Paper A1.0](/zh/publications/tmpa-architecture-paper-a1.0) 解释理论，本 Core Specification 定义规范行为，[Implementation Case Report I1.0](/zh/publications/implementation-case-i1.0) 报告边界明确的工程证据。当前指导关系与历史协同演进必须分开表达：
