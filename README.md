...
| 05 | **A Checkpoint Is Not Permission to Resume** | [Research Center 中文](https://joinwell52-ai.github.io/joinwell52/zh/industry/2026-08-25-checkpoint-not-permission-to-resume) · [Research Center English](https://joinwell52-ai.github.io/joinwell52/en/industry/2026-08-25-checkpoint-not-permission-to-resume) · [OpenAI API · technical discussion](https://community.openai.com/t/agents-sdk-how-do-you-serialize-session-access-during-recovery/1393735) | Asks where multiple workers should serialize the Session history read, recovery decision, and append after an uncertain write; no multi-worker reproduction is claimed. |
| 06 | **Approval Caches Need an Authorization Identity** | [Research Center 中文](https://joinwell52-ai.github.io/joinwell52/zh/engineering/2026-08-28-approval-caches-need-authorization-identity) · [Research Center English](https://joinwell52-ai.github.io/joinwell52/en/engineering/2026-08-28-approval-caches-need-authorization-identity) · [Codex Q&A · technical discussion](https://github.com/openai/codex/discussions/41780) | Asks how external tool-permission changes connect to Guardian cache invalidation or call-time checks; no stale approval is claimed to have been reproduced. |
