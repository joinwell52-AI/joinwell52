...
![A duplicated task notification enters a central state machine, which isolates the fault and permits only one dispatch](./03-visuals/cover-fault-injection-dispatch.png)
...
![The layered relationship among TMPA governance semantics, the FCoP file-protocol projection, CodeFlowMu runtime responsibility, and fault evidence](./03-visuals/figure-governance-to-fault-testing.en.png)

*Figure 1. TMPA defines what should hold, FCoP specifies how it is expressed, and CodeFlowMu implements how it runs. TMPA C01–C14 conformance evidence and this article's 12 product-fault scenarios cannot substitute for one another. Sources: TMPA Core S1.0, FCoP v3, current CodeFlowMu code, and the 2026-08-19 experiment record.*
...
Our current rerun produced a more useful record than an all-green screenshot. Exact commands, environment, exit codes, and raw output are preserved in the [experiment run log](./02-experiment-run-log.md):
