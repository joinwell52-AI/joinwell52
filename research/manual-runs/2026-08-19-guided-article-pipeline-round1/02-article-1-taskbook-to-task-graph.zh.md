...
![密集的长需求信息流进入由四个任务模块咬合而成的数字施工图](./03-visuals/cover-taskbook-to-task-graph.png)
...
![长需求从锁定来源、需求台账、施工图、校验批准到派工验收的五步职责链](./03-visuals/figure-taskbook-five-stage-pipeline.zh.png)
