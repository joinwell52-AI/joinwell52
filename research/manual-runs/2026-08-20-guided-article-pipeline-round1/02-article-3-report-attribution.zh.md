...
![TASK 42 的执行事实与独立验证形成一条证据链，属于 TASK 17 的完整工件被保留在红色归属边界外](../../../staging/publication-candidates/2026-08-20-report-attribution-cover.png)
...
![任务身份与执行轮次绑定开发事实和 QA 验证；报告新旧由替代关系裁决，错属工件被隔离](../../../staging/publication-candidates/2026-08-20-report-attribution-figure-1.png)
