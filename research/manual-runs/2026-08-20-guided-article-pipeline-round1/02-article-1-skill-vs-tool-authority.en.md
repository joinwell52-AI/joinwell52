...
![A computational agent contains a blue learned method while an amber consequential action pauses at a separate authorization boundary for a one-time approval](../../../staging/publication-candidates/2026-08-20-skill-vs-tool-authority-cover.png)
...
![Four layers separately answer how, what may be called, who is affected, and whether this occurrence is approved; approval grants only one controlled execution attempt](../../../staging/publication-candidates/2026-08-20-skill-vs-tool-authority-figure-1.png)
