...
Reference Reader PASS demonstrates only the tested S1.0 paths. It does not establish product conformance or independent validation. The separately locked I0.8 / CodeFlowMu V1.6.0 run remains exact S0.6 author-run evidence and is not relabeled as S1.0 evidence.
...
- The S0.6 exact product run remains predecessor evidence; no new S1.0 product run is asserted.
