...
![多智能体局部安全与端到端路径闭环的题图](staging/publication-candidates/2026-09-07-local-safety-does-not-close-path-cover.png)
...
于是，权限门禁不再只问“智能体 X 能不能调用工具 Y”，还要问“这次调用所依据的权力，是如何变得可达的”。如果高权限调用由低权限来源经共享状态间接塑造，那么调用本身合规，并不自动意味着其来源链合规。
