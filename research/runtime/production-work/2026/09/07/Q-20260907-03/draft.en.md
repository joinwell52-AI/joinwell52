...
research_question: "When autonomous software work spans many invocations or days, which artifact and evidence identities must survive every context window, and why must acceptance remain separate from the implementing claim?"
...
cover: staging/publication-candidates/2026-09-07-project-truth-survives-context-cover.png
sources:
  - research/analysis/Q-20260907-03-durable-project-truth-independent-acceptance.md
---

![Editorial cover for durable project truth across context windows](staging/publication-candidates/2026-09-07-project-truth-survives-context-cover.png)
