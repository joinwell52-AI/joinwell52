...
模型上下文协议 TypeScript SDK 的问题发生在 HTTP（超文本传输协议）传输层。调用方可以提供 Authorization（授权）头、协议版本或会话标识，请求发送器也会根据当前认证与会话状态产生这些值。如果只是通用合并，两套来源可能同时存在；大小写不同的头名甚至可能组合成一个损坏的多值凭据。
...
## Gemini CLI（Gemini 命令行工具）：把控制状态隔离在低信任域之外
...
- [代码智能体：现有线程的受管供应商重新校验](https://github.com/openai/codex/commit/39d193d72d7959d798642bd3e1496bb8865033b1)
- [模型上下文协议工具包：传输管理请求头的优先级](https://github.com/modelcontextprotocol/typescript-sdk/commit/b65426158ed9f29aea8ef3dc09ca22d7d9d6f970)
- [Gemini 命令行工具：沙箱与运行时状态隔离](https://github.com/google-gemini/gemini-cli/commit/9c1b0a610534d6f8120964cf2672c07807d8fc90)
