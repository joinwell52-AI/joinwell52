...
cover: staging/publication-candidates/2026-09-12-evidence-complete-not-execution-authority-cover.png
sources:
  - research/analysis/Q-20260912-01-evidence-completion-not-execution-authority.md
---

![Evidence illuminates an action path while a separate execution gate decides whether it may cross the boundary](staging/publication-candidates/2026-09-12-evidence-complete-not-execution-authority-cover.png)
