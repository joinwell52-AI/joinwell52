...
![A cyan execution path crosses layered frames while an amber lens highlights one stage without claiming to reveal the hidden root](staging/publication-candidates/2026-09-14-stage-attribution-not-root-cause-cover.png)
