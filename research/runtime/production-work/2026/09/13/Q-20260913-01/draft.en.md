...
![A cyan trajectory rewinds inside a controlled boundary while an amber external effect remains unchanged](staging/publication-candidates/2026-09-13-state-rewound-effect-did-not-cover.png)
