...
![角色匹配不等于团队适配的题图](staging/publication-candidates/2026-09-08-role-match-is-not-team-fit-cover.png)
...
| 门禁 | 需要回答的问题 | 典型证据 |
|---|---|---|
| 角色与能力准入 | 新成员能否承担正式职能并使用所需工具 | 能力测试、权限范围、角色合同 |
| 团队协作准入 | 它能否适配目标团队当前约定和依赖 | 目标团队版本、协作探针、交接演练 |
| 状态范围准入 | 哪些知识可以继承，哪些关系状态必须清除或隔离 | 状态来源、适用对象、团队与席位范围 |
| 恢复与激活准入 | 换人后，结果和协作过程是否都稳定到可接受水平 | 任务质量、消息成本、延迟、重试与观察窗口 |
...
- [智能体可互换性主研究](https://arxiv.org/html/2609.05279v1)
