...
**一手证据：** [OpenAI Codex 已合并提交 035295b4](https://github.com/openai/codex/commit/035295b46ee4a5962d0e01a66a888d5bf5da4de4)。该实现与并发回归测试支持授权版本绑定和消费时复核，不证明版本元组覆盖全部权限事实。
