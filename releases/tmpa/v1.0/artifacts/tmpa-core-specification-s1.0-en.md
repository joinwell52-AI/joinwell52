...
The publication contract is fixed across the three maintained documents: the [Architecture Paper A1.0](https://joinwell52-ai.github.io/joinwell52/en/publications/tmpa-architecture-paper-a1.0) explains the theory, this Core Specification defines normative behavior, and the [Implementation Case Report I1.0](https://joinwell52-ai.github.io/joinwell52/en/publications/implementation-case-i1.0) reports bounded engineering evidence. Their current guidance relation and historical co-evolution are distinct:
...
|---|---|
| [Governance Object Schema](https://joinwell52-ai.github.io/joinwell52/spec/tmpa/s1.0/governance-object.schema.json) | `a2829cd7149c3054a52886365f2293a23106b636b0c52799739bfabdab1ff4fa` |
| [Lifecycle Profile Schema](https://joinwell52-ai.github.io/joinwell52/spec/tmpa/s1.0/lifecycle-profile.schema.json) | `481a61ac2485bbaf15d90e9c5a255ad9ce6a55971190f0fe404856be4b10f993` |
| [Reader Result Schema](https://joinwell52-ai.github.io/joinwell52/spec/tmpa/s1.0/reader-result.schema.json) | `4527df7096fe840b85b245e50d5cea576ff359d50a54d17c8873a7b4f458d431` |
| [Conformance Result Schema](https://joinwell52-ai.github.io/joinwell52/spec/tmpa/s1.0/conformance-result.schema.json) | `4b1ecebf83e62d2aa1aff0e79a0cd0ea0a85fbc14a426d5fe873ab40aefdc2fe` |
...
The V1.8.0 package SHA-256 is `9b92b06c3e46c8019362f55075be4ed066cb7a9c0d9859945b6c3b7de8840d04`. It establishes only author-run demonstrated behavior for the exact product revision and input bundle. It does not establish independent validation, third-party certification, semantic truth, universal conformance, hallucination elimination, or independent adoption. I0.8 and the CodeFlowMu V1.6.0 package remain predecessor S0.6 evidence and SHALL NOT be relabeled.
