...
const admitted = [
  ...
  ['production', '2026-08-17T15:00:00+08:00'],
...
expectDecision('production early wake', { task: 'production', now: '2026-08-17T14:59:00+08:00' }, 'Denied', 'not eligible before')
expectDecision('production deterministic baseline needs no image-generation capability', { task: 'production', now: '2026-08-17T15:00:00+08:00', capabilities: commonCapabilities }, 'Admitted')
