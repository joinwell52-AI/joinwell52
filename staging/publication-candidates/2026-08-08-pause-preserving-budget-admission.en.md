...
> Editing status: bilingual structure, admission-vs-termination semantics, overshoot boundary, shared-budget limitation, and authorized-resume requirement preserved; not yet published.
