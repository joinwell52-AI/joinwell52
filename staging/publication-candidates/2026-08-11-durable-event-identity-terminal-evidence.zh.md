...
cover: "staging/publication-candidates/2026-08-11-durable-event-identity-terminal-evidence-cover.svg"
...
![持久身份编辑性题图](./2026-08-11-durable-event-identity-terminal-evidence-cover.svg)

## 解释图

![持久身份与终态证据解释图](./2026-08-11-durable-event-identity-terminal-evidence-figure.svg)
...
> Editing status: PASS for Production Candidate。实现事实、保证范围、失败边界、双语结构与未发布边界已核对；当前仍未发布。
