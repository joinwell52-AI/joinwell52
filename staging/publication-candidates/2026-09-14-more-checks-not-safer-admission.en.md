...
![Several cyan routes enter separate gates while one amber gate aligns only with the selected lane](staging/publication-candidates/2026-09-14-more-checks-not-safer-admission-cover.png)
