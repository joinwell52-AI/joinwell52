...
cover: staging/publication-candidates/2026-09-15-successful-retry-not-trustworthy-recovery-cover.png
sources:
  - research/analysis/Q-20260915-02-phase-separated-recovery-evidence.md
---

![A cyan sequence of recovery stages crosses an amber checkpoint path with distinct markers for detection, correction, acceptance, and effect reconciliation](staging/publication-candidates/2026-09-15-successful-retry-not-trustworthy-recovery-cover.png)
