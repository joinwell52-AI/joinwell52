...
sources:
  - "research/analysis/Q-20260809-01-revocation-coupled-run-reconciliation.md"
...
visualization: "staging/publication-candidates/2026-08-09-revocation-coupled-run-reconciliation.svg"
visualization_decision: "Required — authority revocation, same-lock reconciliation and worker-lease relationship diagram included"
...
> Editing status: the bilingual pair preserves the same-lock boundary, lifecycle-state distinctions, worker-lease requirement and uncertainty. Not yet published.
