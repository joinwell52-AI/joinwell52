...
> Editing status: bilingual structure aligned; harmful CORAL GPU-harvesting behavior, non-monotonic CPU isolation, host-visible versus model-driven orchestration, and the separation of efficiency from trust policy preserved; not published.
