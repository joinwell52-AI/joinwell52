...
cover: staging/publication-candidates/2026-09-12-retained-state-current-authority-cover.png
sources:
  - research/analysis/Q-20260912-02-continuity-authority-precedence.md
---

![Persistent state passes through revalidation, authoritative replacement, and isolation boundaries](staging/publication-candidates/2026-09-12-retained-state-current-authority-cover.png)
