...
![Authority-plane containment mechanism](./2026-08-10-authority-plane-cascade-containment.svg)
...
> Editing status: PASS for Production Candidate. Trusted-state assumption, ablation interpretation, retry/repair distinction, limitations and bilingual evidence boundary checked; not published.
